...
namespace MultiShop.Catalog.Services.ProductImageServices
{
    public class ProductImageService : IProductImageService
    {
        ...
        public ProductImageService(IMapper mapper,IDatabaseSettings _databaseSettings)
        {
            ...
            _productImageCollection = database.GetCollection<ProductImage>(_databaseSettings.ProductDetailCollectionName);
            _mapper = mapper;
        }
        ...
        public async Task UpdateProductImageAsync(UpdateProductImageDto updateProductImageDto)
        {
            ...
            await _productImageCollection.FindOneAndReplaceAsync(x => x.ProductImageId == updateProductImageDto.ProductImagesID, values);
        }
    }
}
